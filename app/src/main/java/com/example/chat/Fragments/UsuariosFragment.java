...
public class UsuariosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView tv_usuarios = view.findViewById(R.id.tv_usuarios);
        ImageView img_usuarios = view.findViewById(R.id.img_usuarios);

        progressBar = view.findViewById(R.id.progresbar);


        tv_usuarios.setText(user.getDisplayName());
        Glide.with(this).load(user.getPhotoUrl()).into(img_usuarios);

        final RecyclerView recyclerView;
        final ArrayList<Usuario>usuarioArrayList;
        final AdaptersUsuario adaptersUsuario;
        ...
        adaptersUsuario = new AdaptersUsuario(usuarioArrayList,getContext());
        recyclerView.setAdapter(adaptersUsuario);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    adaptersUsuario.notifyDataSetChanged();
